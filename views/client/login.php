                    ...
                    <div class="card-body p-3 p-md-4 p-xl-5">
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-4">
                                    <h3>Đăng Nhập</h3>
                                    <p>Bạn không có tài khoản? <a href="#!">Đăng kí</a></p>
                                </div>
                            </div>
                        </div>
                        <form action="#!">
                            <div class="row gy-3 overflow-hidden">
                                ...
                                <div class="col-12">
                                    <div class="d-grid">
                                        <button class="btn btn-lg" style="background-color: #3fbbc0; color: white" type="submit">Đăng nhập ngay</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-2 gap-sm-3 justify-content-centerX">
                                    <a href="#!" class="btn btn-outline-danger bsb-btn-circle bsb-btn-circle-xl">
                                    ...
                                    <a href="#!" class="btn btn-outline-primary bsb-btn-circle bsb-btn-circle-xl">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                                        </svg>
                                    </a>
                                    <a href="#!" class="btn btn-outline-dark bsb-btn-circle bsb-btn-circle-xl">
