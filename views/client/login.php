                    ...
                    <div class="card-body p-3 p-md-4 p-xl-4 mb-5">
                        <div class="row mb-1">
                            <div class="col-12">
                                <div>
                                    <h3>Đăng Nhập</h3>
                                    <p>Bạn không có tài khoản? <a href="http://localhost/Medicio/index.php?controller=register&action=register">Đăng kí</a></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row gy-3 overflow-hidden">
                                <div class="col-12">
                                    <div class="form-floating mb-2">
                                        <input type="tel" class="form-control" name="phone" id="phone" placeholder="name@example.com" required>
                                ...
                                <div class="col-12 mt-4">
                                    <div class="d-grid">
                                        <button id="loginButton"
                                                class="btn btn-lg" style="background-color: #3fbbc0; color: white" type="submit">Đăng nhập ngay</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<script>
    ...
    function redirectToHome() {
        window.location.href = 'http://localhost/Medicio/index.php?controller=home&action=test'; // Điều hướng đến trang chủ sau khi đăng nhập thành công
    }
</script>
</body>
</html>