...
class AppointmentModel extends Database {
    ...
    public function updateAppointment($id, $employee_id, $specialty_id, $date_slot, $time_id,
    ...
    public function getAppointmentToday($limit = 10, $page = 1, $specialty = null, $doctor = null, $date = null, $search = null)
    {
    ...
    public function getAllAppointmentsForAdmin($limit = 10, $page = 1, $specialty = null, $doctor = null,
                                               $statusAppointment = null, $search = null) {
        $offset = ($page - 1) * $limit;
        $sql = "SELECT a.appointment_id AS id, 
                    e.name AS doctor_name,
                   e.avt AS doctor_avt,
    ...
    public function getTotalAppointmentsWithParam($specialty = null, $doctor = null,
                                                  $statusAppointment = null, $search = null) {
        $sql = "SELECT COUNT(*) AS total FROM appointments AS a
            JOIN employees AS e ON e.employee_id = a.employee_id
            JOIN roles AS r ON r.role_id = e.role_id
